...
\begin{abstract}
This report summarizes the works which have been presented by the Intelligent Systems Research Institute of Sungkyunkwan University to the community of artificial intelligence and robotics. Five relevant articles published by the Institute during 2015 to 2018 are reviewed in order to exhibit the research progress made on cognitive capabilities of service robots. Research topics discussed throughout this report include feature extraction, object recognition, semantic understanding, autonomous localization, and sensor fusion. From the articles, novel frameworks such as the Covariance Projection Filtering and the Adaptive Bayesian Recognition, as well as new algorithms like the Major Line Extraction, are introduced. In addition to sketching out key contributions and technical details, this report also illustrates the experimental results from each work with certain amount of analysis. Furthermore, discussions are carried out for each article so as to help evaluating the significance of our contributions. The proposed methodologies have all been implemented on real-world setups, while a number of experiments have verified their feasibility and effectiveness. With all the evidences, one can easily conclude that the Institute has pushed forward the boundary of cognitive robotics in recent years.
\end{abstract}
